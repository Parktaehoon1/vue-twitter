        ...
        >
          ...
          <div>
            <div class="flex space-x-1">
              <div class="font-bold">taehoon</div>
              <div class="text-gray-500">@taehoon</div>
              <div class="text-gray-500">9월 27일</div>
            </div>
    ...
    <div class="w-3/5 border-r border-gray-100">
      <div class="flex flex-col h-screen">
        ...
        <div class="flex px-3 h-14 items-center border-b border-gray-100">
          ...
          />
          <div>
            <div class="font-bold text-lg">taehoon.com</div>
            <div class="text-sm text-gray-500">@taehoon</div>
          </div>
        </div>
        <!-- user info -->
        <div class="flex flex-col justify-center items-center border-b border-gray-100 hover:bg-gray-50 py-6">
          <div>
            <span class="font-bold mr-1">taehoon.com</span>
            <span class="text-gray-500">@taehoon</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span class="text-gray-500">2022년 9월</span>
          </div>
        </div>
        <div class="flex-1 overflow-y-scroll">
        <!-- chat bubble : my chat -->
        <div class="text-right px-3 py-3">
          <span class="bg-primary text-white px-4 py-2 rounded-full">메세지</span>
          <div class="mt-2 text-xs text-gray-500">2022년 9월 27일 오전 1:05</div>
        </div>
        ...
        <div class="flex items-center bg-white border-t border-gray-100 sticky">
          <input type="text" class="m-2 py-1 px-4 rounded-full bg-gray-100 resize-none outline-none flex-1" placeholder="새 쪽지 작성하기">
